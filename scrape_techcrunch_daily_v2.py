...
def main():
    ...
    print("Starting TechCrunch daily scraper (NEW SCHEMA)...")
    ...
    for url in article_urls:
        ...
        # We need to check against both old deals table and new deals table
        try:
    ...
    print(f"\n🎉 Daily scrape complete! Added {new_articles_found} new articles using NEW SCHEMA.")
